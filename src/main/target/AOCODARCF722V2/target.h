...
#define USBD_PRODUCT_STRING  "AocodaRCF722V2"
...
#define USE_PINIO
#define USE_PINIOBOX
#define PINIO1_PIN                  PA14  // bluetooth
#define PINIO2_PIN                  PA15  //Camera control
#define PINIO3_PIN                  PA13 // IO high and low level switching control
