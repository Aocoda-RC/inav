...
timerHardware_t timerHardware[] = {
    //DEF_TIM(TIM1, CH3, PA10, TIM_USE_PPM, 0, 0),    //PPM      //D(2, 6, 6)

    DEF_TIM(TIM8, CH1, PC6, TIM_USE_OUTPUT_AUTO, 0, 0),        // S1   D(2, 2, 7)
    ...
    DEF_TIM(TIM3, CH3, PB0, TIM_USE_OUTPUT_AUTO, 0, 0),        // S5   D(1, 7, 5)
    DEF_TIM(TIM3, CH4, PB1, TIM_USE_OUTPUT_AUTO, 0, 0),        // S6   D(1, 2, 5)
    DEF_TIM(TIM4, CH1, PB6, TIM_USE_OUTPUT_AUTO, 0, 0),        // S7   D(1, 0, 2)
    DEF_TIM(TIM4, CH2, PB7, TIM_USE_OUTPUT_AUTO, 0, 0),        // S8   D(1, 3, 2)
    
    DEF_TIM(TIM2, CH1, PA0, TIM_USE_LED, 0, 0),    // LED_TRIP    D(1, 5, 3)
};
